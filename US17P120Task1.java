//Task 1: Validate that when no customer checkbox is selected and the Delete button is clicked,
...
public class US17P120Task1 {
	...
	public static void CheckBoxIsNotSelected(WebDriver driver){
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(10));
		WebElement checkBox=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//table/tbody/tr[4]/td[1]/input")));
		checkBox.click();
		try{
